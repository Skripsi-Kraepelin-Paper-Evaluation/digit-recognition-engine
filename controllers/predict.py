...
class PredictHandler:
    def __init__(self, persistent_path='./persistent',min_accuracy=0.8,questions_fixed=[]):
    ...
    def handle_predict(self, filename):
        ...
        result = {
            ...
            'answers': [a.serialize_obj() for a in answers_sorted],
...
def create_predict_blueprint(inference_engine,cfg):
    ...
    predict_handler = PredictHandler(persistent_path=cfg.persistent_path,min_accuracy=cfg.min_accuracy,questions_fixed=cfg.questions_fixed)
